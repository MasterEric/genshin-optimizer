      ...
      <Card bg="darkcontent" text="lightfont">
        ...
        <Card.Body>
          <Card bg="lightcontent" text="lightfont" className="mb-2"><Card.Body><Row ><Col>
            <Trans i18nKey="home:paragraph-intro">
          ...
          <Card bg="lightcontent" text="lightfont" className="mb-2"><Card.Body><Row>
            ...
            <Col>
              <Trans i18nKey="home:paragraph-artifact-editor">
          ...
          <Card bg="lightcontent" text="lightfont" className="mb-2"><Card.Body><Row>
            <Col>
              <Trans i18nKey="home:paragraph-character-editor">
          ...
          <Card bg="lightcontent" text="lightfont" className="mb-2"><Card.Body><Row>
            ...
            <Col>
              <Trans i18nKey="home:paragraph-character-damage-calculations">
          ...
          <Card bg="lightcontent" text="lightfont" className="mb-2"><Card.Body><Row>
            <Col>
              <Trans i18nKey="home:paragraph-build-generator">
          ...
          <Card bg="lightcontent" text="lightfont" className="mb-2"><Card.Body><Row>
            ...
            <Col>
              <Trans i18nKey="home:paragraph-tools">
          ...
          <Card bg="lightcontent" text="lightfont" className="mb-2"><Card.Body><Row>
            <Col xs={12} md={6}>
              <Trans i18nKey="home:paragraph-future">
            ...
            <Col xs={12} md={6}>
              <Trans i18nKey="home:paragraph-help-development">
          ...
          <Card bg="lightcontent" text="lightfont" ><Card.Body>
            <Trans i18nKey="home:paragraph-credits">
